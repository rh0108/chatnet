...
if (file_exists(BASE_PATH.'config/settings.php')) {
    ...
    /*============================ SCHEDULER ============================*/
    $route->get('/js/chatschedule_js', 'App\homeController@chatschedule_js')->as('chatschedule_js');
    /*============================ /SCHEDULER ============================*/
    ...
    /*============================ SCHEDULER ============================*/
    $route->any('cron/schedule-chats', 'App\cronController@schedule_chats')->as('cron-schedule-chats');
    /*============================ /SCHEDULER ============================*/
